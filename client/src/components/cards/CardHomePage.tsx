            ...
            {loading ? (
                <Box
                    sx={{
                        ...
                        minWidth: '210px', // Adjust the width to half of the original
                        minHeight: '180px', // Adjust the height to half of the original
                    }}
                >
                    <Grid
                        sx={{
                            ...
                            alignItems: 'center',
                            width: '210px', // Adjust the width to half of the original
                        }}
                    >
                ...
                <Card
                    sx={{
                        maxWidth: '125px', // Adjust the width to half of the original
                        maxHeight: '250px', // Adjust the height to half of the original
                        height: '175px', // Adjust the height to half of the original
                        margin: '5px',
